...
(function(window, document) {
        ...
        render: function() {
            ...
            return (
                React.createElement("li", {className: done}, 
                    React.createElement("a", {href: "/domains/" + this.props.module.domain + "/modules/M1.html"}, this.props.module.name)
                )
            );
        }
    });
    ...
    var Modules = React.createClass({displayName: "Modules",
        render: function() {
            ...
            return React.createElement("ul", {className: "modules"}, modules);
        }
    });
    ...
    var Sidebar = React.createClass({displayName: "Sidebar",
        ...
        render: function() {
            var modules = "paths" in this.state.user ? React.createElement(Modules, {path: this.state.user.paths[0]}) : "Log in";
