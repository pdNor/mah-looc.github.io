...
(function(window, document) {
    ...
    var Domain = React.createClass({displayName: "Domain",
        handleModuleSelection: function(module, i) {
            console.log(module, i);
        },
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", ref: "m" + i, onChange: this.handleModuleSelection(module, i)}), " ", module.name));
            }.bind(this));

            return (
                React.createElement("li", null, 
                    React.createElement("span", null, this.props.domain.name), React.createElement("ul", {class: "modules"}, modules)
                )
            );
        }
    });
