    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            ...
            var input = this.state.verify
                    ? React.createElement("label", null, React.createElement("input", {type: "text", value: "", onChange: this.handleCodeChange}), "Code")
                    : React.createElement("label", null, React.createElement("input", {type: "text", value: "", onChange: this.handleEmailChange}), "Email");
