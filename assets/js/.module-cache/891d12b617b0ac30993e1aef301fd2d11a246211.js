    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module) {
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", ref: module.id, onChange: this.handleModuleSelection.bind(module)}), " ", module.name));
            }.bind(this));
