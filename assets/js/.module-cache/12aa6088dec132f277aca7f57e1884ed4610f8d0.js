...
(function(window, document) {
    ...
    var Module = React.createClass({displayName: "Module",
        ...
        render: function() {
            var input = React.createElement("input", {type: "checkbox", ref: "module", checked: this.state.isChecked, onChange: this.handleChange});
    ...
    var Domain = React.createClass({displayName: "Domain",
        handleModuleSelection: function(m) {
            var isChecked = m.refs.module.getDOMNode().checked;
