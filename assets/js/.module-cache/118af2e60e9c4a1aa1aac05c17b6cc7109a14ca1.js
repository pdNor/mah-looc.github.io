...
(function(window, document) {
    ...
    var Module = React.createClass({displayName: "Module",
        ...
        render: function() {
            var input = React.createElement("input", {type: "checkbox", ref: "module", checked: this.props.checked, onChange: this.handleChange});
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement(Module, {key: i, module: module, checked: false, addChoice: this.props.addChoice, removeChoice: this.props.removeChoice});
            }.bind(this));
