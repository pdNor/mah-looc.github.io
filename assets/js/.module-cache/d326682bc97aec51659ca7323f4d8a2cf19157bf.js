...
(function(window, document) {
    ...
    var Module = React.createClass({displayName: "Module",
        ...
        handleChange: function() {
            // this.setState({ isChecked: this.refs.module.getDOMNode().checked });
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        handleModuleSelection: function(m) {
            console.log(React.findDOMNode(m));
            if (m.refs.module.getDOMNode().checked) {
        ...
        handleClick: function(modules) {
            return function() {
                console.log(React.findDOMNode(modules[0]));
            };
        },
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement(Module, {key: i, module: module, ref: "module", onChange: this.handleModuleSelection, addChoice: this.props.addChoice, removeChoice: this.props.removeChoice});
            }.bind(this));
