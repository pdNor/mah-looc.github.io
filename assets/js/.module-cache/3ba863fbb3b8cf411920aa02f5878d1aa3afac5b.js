...
(function(window, document) {
    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            var message = this.state.showMessage ? React.createElement(Message, {msg: this.state.message, type: this.state.messageType, clickHandler: this.state.handleMessageClick.bind(this)}) : "";
