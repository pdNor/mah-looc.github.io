...
(function(window, document) {
    ...
    var Message = React.createClass({displayName: "Message",
        render: function() {
            var message = this.props.show ? React.createElement("p", {class: "message {this.props.type}"}, this.props.msg) : "";
            return React.createElement("div", {class: "message-container", onClick: this.props.clickHandler}, message);
        }
    });
        ...
        render: function() {
            return (
                React.createElement("div", {class: "create-path"}, 
                    React.createElement(Message, {msg: this.state.message, type: this.state.messageType, show: this.state.messageShow, clickHandler: this.state.handleMessageClick}), 
