...
(function(window, document) {
    ...
    var ModuleItem = React.createClass({displayName: "ModuleItem",
        ...
        render: function() {
            var label = React.createElement("input", {type: "checkbox", checked: this.state.isChecked, value: this.state.module.id, onChange: this.onChange});

            return React.createElement("li", null, React.createElement("label", null, label, this.state.module.name, " ", this.state.isChecked ? "is k" : "is no k"));
        }
    });
