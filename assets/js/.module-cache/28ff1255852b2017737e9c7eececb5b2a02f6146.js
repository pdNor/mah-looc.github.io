    ...
    var Domain = React.createClass({displayName: "Domain",
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                var m = module[i];
                m.checked = false;
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", onChange: this.handleModuleSelection(m)}), " ", m.name));
            }.bind(this));
