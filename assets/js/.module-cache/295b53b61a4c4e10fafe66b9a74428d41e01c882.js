...
(function(window, document) {
    ...
    var ModuleItem = React.createClass({displayName: "ModuleItem",
        getInitialState: function() {
            return { module: this.props.data };
        },
        handleChange: function(event) {
            console.log(event);
        },
        render: function() {
            return React.createElement("li", null, React.createElement("input", {type: "checkbox", value: this.state.module.id, onChange: this.handleChange}), this.state.module.name);
        }
    });
