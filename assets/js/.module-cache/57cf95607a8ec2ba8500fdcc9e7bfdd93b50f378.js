    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            ...
            var input = this.state.verify
                    ? React.createElement("input", {type: "text", value: this.state.code, onChange: this.handleCodeChange})
                    : React.createElement("input", {type: "text", value: this.state.email, onChange: this.handleEmailChange});
