...
(function(window, document) {
    ...
    var Message = React.createClass({displayName: "Message",
        ...
        render: function() {
            var message = this.state.show ? React.createElement("p", {class: "message {this.props.type}", onClick: this.handleClick}, this.props.msg) : "";
            return React.createElement("div", {class: "message-container"}, message);
        }
    });
        ...
        render: function() {
            return (
                React.createElement("div", {class: "create-path"}, 
                    React.createElement(Message, {msg: this.state.message, type: this.state.messageType}), 
