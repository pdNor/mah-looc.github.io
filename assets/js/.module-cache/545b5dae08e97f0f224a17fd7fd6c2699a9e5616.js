...
(function(window, document) {
    ...
    var PathActions = React.createClass({displayName: "PathActions",

        render: function() {
            return (
                React.createElement("div", {class: "path-actions"}, 
        ...
        render: function() {
            return (
                React.createElement("div", {id: "path-form"}, 
                    ...
                    React.createElement(PathActions, {choices: this.state.choices})
                )
            );
        }
    });
