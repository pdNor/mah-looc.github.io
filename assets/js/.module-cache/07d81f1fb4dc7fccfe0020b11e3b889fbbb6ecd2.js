...
(function(window, document) {
    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        handleSubmit: function() {
            ...
            if (!this.state.input.length || !this.props.choices.length) {
                this.setState({
                    msg: {
            ...
            var payload = {
                email: this.state.email || this.state.input,
            ...
            if (User) {
                ...
                payload.code = (this.state.email && this.state.input) ? this.state.input : "";
            }
