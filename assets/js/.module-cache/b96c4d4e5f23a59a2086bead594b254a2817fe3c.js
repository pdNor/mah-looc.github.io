    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement(Module, {key: i, ref: "module", onChange: this.handleModuleSelection, addChoice: this.props.addChoice, removeChoice: this.props.removeChoice});
            }.bind(this));
