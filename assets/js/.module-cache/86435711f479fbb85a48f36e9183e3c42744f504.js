...
(function(window, document) {
    ...
    var Module = React.createClass({displayName: "Module",
        handleChange: function() {
            this.props.handleModuleSelection(this);
        ...
        render: function() {
            var input = React.createElement("input", {type: "checkbox", ref: "module", onChange: this.handleChange});
    ...
    var Domain = React.createClass({displayName: "Domain",
        handleModuleSelection: function(module) {
            var isChecked = module.refs.module.getDOMNode().checked;

            if (isChecked) {
                module.props.addChoice(module.props.module);
            } else {
                module.props.removeChoice(module.props.module);
            }
        },
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement(Module, {key: i, module: module, onChange: this.handleModuleSelection, addChoice: this.props.addChoice, removeChoice: this.props.removeChoice});
            }.bind(this));

            return React.createElement("li", null, React.createElement("span", {onClick: this.handleClick(modules)}, this.props.domain.name), React.createElement("ul", {class: "modules"}, modules));
        }
    });
