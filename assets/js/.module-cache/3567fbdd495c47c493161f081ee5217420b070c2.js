...
(function(window, document) {
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", ref: "m" + i, onChange: this.handleModuleSelection}), " ", module.name));
            }.bind(this));
