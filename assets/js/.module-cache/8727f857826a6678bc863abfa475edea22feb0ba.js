    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            ...
            var input = this.state.verify
                    ? React.createElement("label", {class: "code"}, React.createElement("input", {type: "text", ref: "code", onChange: this.handleCodeChange}), "Code")
                    : React.createElement("label", {class: "email"}, React.createElement("input", {type: "text", ref: "email", onChange: this.handleEmailChange}), "Email");
