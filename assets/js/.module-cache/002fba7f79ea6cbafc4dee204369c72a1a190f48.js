...
(function(window, document) {
    ...
    //     },
    //     render: function() {
    //         var input = <input type="checkbox" checked={this.state.isChecked} onChange={this.handleChange} />;
    ...
    //         return <li><span>{this.props.domain.name}</span><ul class="modules">{modules}</ul></li>;
    //     }
    // });
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
                ...
                return (
                    React.createElement("li", null, 
                        React.createElement("label", null, 
                            React.createElement("input", {type: "checkbox", checked: module.checked, onChange: this.handleModuleSelection(module)}), " ", module.name
                        )
                    )
                );
            }.bind(this));
            ...
            return (
                React.createElement("li", null, 
                    React.createElement("span", null, React.createElement("input", {type: "checkbox", onChange: this.handleDomainSelection}), this.props.domain.name), 
