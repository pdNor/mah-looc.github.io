...
(function(window, document) {
    ...
    var ModuleItem = React.createClass({displayName: "ModuleItem",
        ...
        render: function() {
            return React.createElement("li", null, React.createElement("input", {type: "checkbox", checked: this.state.isChecked, value: this.state.module.id, onChange: this.onChange}), this.state.module.name);
        }
    });
