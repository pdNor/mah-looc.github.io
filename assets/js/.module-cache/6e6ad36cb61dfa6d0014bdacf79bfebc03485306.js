...
(function(window, document) {
    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            ...
            var input = this.state.verify
                    ? React.createElement("label", null, React.createElement("input", {type: "text", value: this.state.code, onChange: this.handleCodeChange}), "Code")
                    : React.createElement("label", null, React.createElement("input", {type: "text", value: this.state.email, onChange: this.handleEmailChange}), "Email");
