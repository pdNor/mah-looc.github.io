...
(function(window, document) {
    ...
    var Message = React.createClass({displayName: "Message",
        render: function() {
            return React.createElement("div", {class: "message-container", onClick: this.props.clickHandler}, React.createElement("p", {class: "message {this.props.type}"}, this.props.msg));
        }
    });
    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            var message = this.state.showMessage ? React.createElement(Message, {msg: this.state.message, type: this.state.messageType, show: this.state.showMessage, clickHandler: this.state.handleMessageClick}) : "";
            return (
