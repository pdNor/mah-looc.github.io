            ...
            if (this.state.verify) {
                input = (
                    React.createElement("div", null, 
                        React.createElement("label", null, 
                            "Code ", React.createElement("input", {type: "text", onChange: this.handleCodeChange})
                        ), 
                        React.createElement("button", {type: "button", onClick: this.handleCancel}, "Avbryt")
                    )
                );
            } else {
                input = React.createElement("label", null, "Email ", React.createElement("input", {type: "text", onChange: this.handleEmailChange}));
            }
    ...
    var Input = React.createClass({displayName: "Input",
        render: function() {
            ...
            if (this.props.verify) {
                input = (
                    React.createElement("div", null, 
                        "Code ", React.createElement("input", {type: "text", onChange: this.props.handleCodeChange}), 
                        React.createElement("button", {type: "button", onClick: this.props.handleCancel}, "Avbryt")
                    )
                );
            } else {
                input = React.createElement("div", null, "Email ", React.createElement("input", {type: "text", onChange: this.props.handleEmailChange}));
            }
