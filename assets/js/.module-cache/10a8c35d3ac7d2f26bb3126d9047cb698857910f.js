...
(function(window, document) {
    ...
    var Message = React.createClass({displayName: "Message",
        render: function() {
            return React.createElement("p", {className: "message " + this.props.type, onClick: this.props.clickHandler}, this.props.msg);
        }
    });
    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            var message = this.state.showMessage ? React.createElement(Message, {msg: this.state.message, type: this.state.messageType, clickHandler: this.hideMessage}) : "";
