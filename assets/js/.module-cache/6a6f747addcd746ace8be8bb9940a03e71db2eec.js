...
(function(window, document) {
    ...
    var Path = React.createClass({displayName: "Path",
        render: function() {
            ...
            return React.createElement("ol", {class: "choices"}, choices);
        }
    });
    ...
    var PathForm = React.createClass({displayName: "PathForm",
        ...
        addChoice: function(choice) {
            ...
            // });
            this.props.choices = this.props.choices.concat(choice);
        },
        ...
        render: function() {
            return (
                React.createElement("form", null, 
                    ...
                    React.createElement(Path, {choices: this.props.choices}), 
                    React.createElement(CreatePath, {choices: this.props.choices}), 
    ...
    window.addEventListener("load", function load() {
        ...
        React.render(
            React.createElement(PathForm, {choices: c}),
