...
(function(window, document) {
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        handleDomainSelection: function() {
            console.log(this);
            this.refs.map(function(ref) {
                console.log(React.findDOMNode(ref).checked);
            });
        },
        render: function() {
            var modules = this.props.domain.modules.map(function(module) {
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", ref: "m" + module.id, onChange: this.handleModuleSelection(module)}), " ", module.name));
            }.bind(this));
