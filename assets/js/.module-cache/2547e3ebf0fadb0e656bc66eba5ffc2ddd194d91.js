...
(function(window, document) {
    ...
    var Domain = React.createClass({displayName: "Domain",
        handleModuleSelection: function(module) {
            return function() {
                console.log(React.findDOMNode(this.refs[module.id]).checked);
            };
        },
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module) {
                return React.createElement("li", null, React.createElement("label", null, React.createElement("input", {type: "checkbox", ref: module.id, onChange: this.handleModuleSelection(module)}), " ", module.name));
            }.bind(this));
