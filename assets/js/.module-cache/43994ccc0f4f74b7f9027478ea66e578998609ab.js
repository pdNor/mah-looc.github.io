...
(function(window, document) {
    ...
    var Module = React.createClass({displayName: "Module",
        ...
        handleChange: function() {
            this.setState({ isChecked: this["module"+this.key].module.getDOMNode().checked });
    ...
    var Domain = React.createClass({displayName: "Domain",
        ...
        render: function() {
            var modules = this.props.domain.modules.map(function(module, i) {
                return React.createElement(Module, {key: i, module: module, ref: "module{i}", onChange: this.handleModuleSelection, addChoice: this.props.addChoice, removeChoice: this.props.removeChoice});
            }.bind(this));
