    ...
    var CreatePath = React.createClass({displayName: "CreatePath",
        ...
        render: function() {
            ...
            var input = this.state.verify
                    ? React.createElement("p", null, React.createElement("input", {type: "text", onChange: this.handleCodeChange}), "Code")
                    : React.createElement("div", null, React.createElement("input", {type: "text", onChange: this.handleEmailChange}), "Email");
